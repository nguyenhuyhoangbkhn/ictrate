...
public class CriteriaDaoImpl implements CriteriaDao {
	...
	public List<Criteria> getAllCriteria() {
		...
		String sql = "SELECT CRITERIA.ID, CRITERIA.NAME , CRITERIA.NOTE, TYPE_CRITERIA.NAME AS TYPE_CRITERIA , STEP_SCORE.NAME AS TYPE_SCORE,CRITERIA.FLAG_DELETE, CRITERIA.AMONG FROM  CRITERIA INNER JOIN TYPE_CRITERIA ON TYPE_CRITERIA.ID = CRITERIA.TYPE_CRITERIA INNER JOIN STEP_SCORE ON CRITERIA.TYPE_SCORE = STEP_SCORE.ID WHERE CRITERIA.FLAG_DELETE = 0";
	...
	public List<Criteria> getCriteriaAndScore() {
		String sql = "SELECT CRITERIA.ID,CRITERIA.NAME,STEP_SCORE.NOTE,STEP_SCORE.DETAIL_SCORE,"
				+ "CRITERIA.TYPE_SCORE,CRITERIA.FLAG_DELETE,CRITERIA.AMONG " + "FROM CRITERIA  INNER JOIN STEP_SCORE "
